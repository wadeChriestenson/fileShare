...
SECRET_KEY = 'django-insecure-ah#5=my7v0x@ro2ulor0h6*l-$6xm8q++%z7hih(n)a5%*dkj!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
AUTH_USER_MODEL = 'standard.User'
# Auth0 settings
...
MEDIA_ROOT = BASE_DIR / 'standard/uploaded'
MEDIA_URL = '/standard/static/uploaded/'
